...
namespace CustomerManagement.API.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="request">Dados para cria��o do cliente.</param>
        ...
        public async Task<IActionResult> CreateCustomer([FromBody] CreateCustomerRequest request)
        {
            ...
            {
                _logger.LogWarning(ex, "Erro de dom�nio ao criar cliente: {Message}", ex.Message);
                return BadRequest(new { message = ex.Message });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Erro interno ao criar cliente.");
                return StatusCode(StatusCodes.Status500InternalServerError, new { message = "Ocorreu um erro interno ao processar sua requisi��o." });
            }
        }
        ...
        /// <summary>
        /// Lista todos os clientes com pagina��o opcional.
        /// </summary>
        ...
        /// <summary>
        /// Atualiza os dados b�sicos de um cliente existente.
        /// </summary>
        ...
        public async Task<IActionResult> UpdateCustomer(Guid id, [FromBody] UpdateCustomerRequest request)
        {
            ...
            {
                _logger.LogWarning(ex, "Erro de dom�nio ao atualizar cliente {CustomerId}: {Message}", id, ex.Message);
                return BadRequest(new { message = ex.Message });
            }
            catch (Exception ex)
            {
        ...
        /// <returns>Status de sucesso sem conte�do.</returns>
        [HttpDelete("{id:guid}")]
        ...
        public async Task<IActionResult> AddEmail(Guid id, [FromBody] EmailRequest request)
        {
            ...
            {
                _logger.LogWarning(ex, "Erro de dom�nio ao adicionar email ao cliente {CustomerId}: {Message}", id, ex.Message);
                return BadRequest(new { message = ex.Message });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> AddPhone(Guid id, [FromBody] PhoneRequest request)
        {
            ...
            {
                _logger.LogWarning(ex, "Erro de dom�nio ao adicionar telefone ao cliente {CustomerId}: {Message}", id, ex.Message);
                return BadRequest(new { message = ex.Message });
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Adiciona um novo endere�o a um cliente existente.
        /// </summary>
        /// <param name="id">ID do cliente.</param>
        /// <param name="request">Dados do endere�o a ser adicionado.</param>
        /// <returns>O cliente atualizado.</returns>
        ...
        public async Task<IActionResult> AddAddress(Guid id, [FromBody] AddressRequest request)
        {
            ...
            {
                _logger.LogWarning(ex, "Erro de dom�nio ao adicionar endere�o ao cliente {CustomerId}: {Message}", id, ex.Message);
                return BadRequest(new { message = ex.Message });
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Erro interno ao adicionar endere�o ao cliente {CustomerId}.", id);
                return StatusCode(StatusCodes.Status500InternalServerError, new { message = "Ocorreu um erro interno ao processar sua requisi��o." });
            }
        }
    }
